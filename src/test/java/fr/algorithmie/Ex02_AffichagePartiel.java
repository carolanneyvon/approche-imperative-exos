...
public class Ex02_AffichagePartiel {
	...
	public void affichageValeursSup3() {
		...
		System.out.println("Les valeurs supérieures ou égales à 3 sont : ");
	...
	public void affichageValeursPaires() {
		...
		// comme pair)
		System.out.println("Les valeurs paires sont : ");
	...
	public void affichageIndexPairs() {
		...
		System.out.println("Les valeurs correspondant aux index pairs sont : ");
